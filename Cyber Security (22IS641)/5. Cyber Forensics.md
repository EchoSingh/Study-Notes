...
In **Chapter 1**, it was stated that "hacking" involves unauthorized access to computer systems. Effective **penetration testing** requires a deep understanding of hacker methods and motivations. The following subsections describe the typical steps taken by network attackers (refer to Fig. 7.21).
...
Refer to **Table D.1.13 in Appendix D** (in CD) for related information.
...
### 7.14 Practical Relevance of OSI Layers in Security
...
### 7.15 Obfuscated IP Addresses and Spam
...
Example:  
A human-readable IP (e.g., `135.17.243.191`) may appear in **10-digit integer** (base-256) format like:
